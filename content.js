...
void girarRapidoDer() {
  ...
  analogWrite(3, 0); analogWrite(9, 0);
    ...
    {
          id: "paso-funciones",
          title: "Estructura Profesional de Funciones",
          subtitle: "Paso 11",
          icon: "Code",
          explanation: `<div class="space-y-4">
            <p class="font-medium text-slate-800">Organizamos toda la inmensa cantidad de código usando funciones propias.</p>
            <p class="text-[15px] text-slate-600 leading-relaxed">Con 5 casos más las memorias, el loop principal (void loop) puede ser abrumador. Encapsular la lógica en funciones hace que vuelva a ser conciso como leer una historia lógica pura de acciones (avanzar, curva suave, giro brusco).</p>
          </div>`,
          code: `int umbral = 500;
int velocidadMax = 180;
int velocidadMedia = 90;
...
// === MIS FUNCIONES DE CONTROL DE MOTORES ===
