    ...
    },
{
      ...
      icon: "Zap",
      color: "blue",
      image: "Imagenes/course_aventura.png",
      classes: [
        {
          id: "intro-fisica",
...
void girarDerecha() {
  ...
  analogWrite(10, velocidadMin);
    ...
    },
    {
      ...
      icon: "Cpu",
      color: "purple",
      image: "Imagenes/course_desafio.png",
      classes: [
...
void loop() {
  ...
  if (tag != "") {
    ...
    },
    {
      ...
      icon: "Shield",
      color: "emerald",
      image: "Imagenes/course_pared.png",
      classes: [
        {
          id: "wf-intro",
...
`
    ...
    },
    {
      ...
      icon: "Columns",
      color: "blue",
      image: "Imagenes/course_pasillos.png",
      classes: [
        {
          id: "wf-pasillo-intro",
